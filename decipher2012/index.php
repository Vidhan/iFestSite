...
<div id="content">
    ...
    <div class="gboxtop"></div>
     ...
     <div id="center">
			<h2 class="style11">I.Funda</h2> <br/> "The Big Bang Query"<br/>
...
So register,play and win lots of prizes. 
 </p>
        ...
        <div id="right">
			...
			<form method="post" action="login.php">
			  <table width="261" height="134" id="personalinfo">
                ...
                <tr id="Name-div">
                  <td><label for="Username"><span class="style9">Team Name</span></label></td>
