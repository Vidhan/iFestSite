...
--
-- Host: localhost
-- Generation Time: Sep 23, 2012 at 05:34 AM
...
INSERT INTO `googlockdareg` (`Teamname`, `member1`, `member2`, `password`, `Contactno`, `emailid`) VALUES
...
CREATE TABLE `googlockquestions` (
  `no` int(11) NOT NULL,
...
CREATE TABLE `googlockstart_end` (
  `no` int(11) NOT NULL,
...
('superuser', 0, '54c84b40e9ff5a31472904a0cd2f0a17', 0, 0),
