...
<head>
	...
	<title><?php if($done==1){ echo"You have shown excellent abilities. I confer you the first funda!";} else echo"You are on question: ". $no. " HURRY!";?></title>
...
HERE;
		...
		?>
			...
			<form action="validate.php" method="post">
				...
				if($done==1) {echo "<br/><p class=\"style14\"><em>Keep Refreshing your page for more questions...</em> </p>
				...
				echo "<p>Answer $no: $question[question] </p>";} if(isset($_GET["attempt"]) && $_GET["attempt"]=="incorrect") echo"You did not enter any answer";?> 			
