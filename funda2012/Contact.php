...
<div id="content">
    ...
    <div class="gboxtop"></div>
     ...
     <div id="center1">
			 <h2 class="style11"> Coordinators: </h3>
		  <p>&nbsp;</p>
		  <table width="600" height="140" border="0" align="center">
            <tr>
              <th  height="40" width="232" bgcolor="#eee" color="6a5acd" scope="col"><span class="style4">Name </span></th>
              <th width="242" bgcolor="#eee" scope="col"><span class="style4">E-mail id</span></th>
              <th width="315" bgcolor="#eee" scope="col"><span class="style4">Phone Number </span></th>
            </tr>
            <tr>
              <td height="50" bgcolor="#eee"><div align="center" class="style2">Nitin Sachdeva</div></td>
              <td bgcolor="#eee"><div align="center" class="style2">201001060@daiict.ac.in</div></td>
              <td bgcolor="#eee"><div align="center" class="style2">9376516001</div></td>
            </tr>
            <tr>
              <td height="50" bgcolor="#eee"><div align="center" class="style2">Prashu Chaudhary</div></td>
              <td bgcolor="#eee"><div align="center" class="style2">201001136@daiict.ac.in</div></td>
              <td bgcolor="#eee"><div align="center"><span class="style2">7878778867</span></div></td>
            </tr>
