...
<div id="content">
    ...
    <div class="gboxtop"></div>
     ...
     <ul id="menu">
			...
			<li><a href="About.php" class="current">Rules</a></li>
			<li><a href="Contact.php">Contact Us</a></li>
			<li><a href="registration.php">Registration</a></li>
		</ul>
        
     <div id="center1">
			<h2 class="style11">Event Structure</h2>
			
<p>
<ul class="style9">
<li>i.Funda is an individual event</li>
<li>The contest will consist of 40 multiple choice questions.</li>
<li>Time allotted will be 1 hr.</li>
<li>For each correct answer, participants will be awarded 1 mark.</li>
<li><b>Don't forget to submit the answer after answering.</b></li>
<li><b>Once you skip/submit a question you can't return to that later.</b></li>
<li>There will be no negative marking.</li>
<li>Participants from DAIICT  have to register using their student mail ID(Eg:201001035@daiict.ac.in) only. This is mandatory for claiming the prize money.</li>
<li>Any sort of malpractice like multiple accounts shall result in disqualification and coordinators decision shall be considered final.</li>
<li>In case of any controversy, the decison of the co-ordinators will be treated as final.</li>
